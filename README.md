#start sonu kumar code..................

# Open5GS Docker Lab (4G/5G + IMS)
### Maintained by: sonutelcoandai

This repository provides a **ready-to-run Docker-based Open5GS lab** for Kernel: 6.12.0-106.55.4.2.el9uek.x86_64
OS: Oracle Linux 9 / RHEL 9 based

including:

5G core +IMS VoLTE+VoNR
...
#✅ ✅ Clone Repository 
git clone https://github.com/sonutelcoandai/docker_open5gs.git
cd docker_open5gs
#Start everything
./start_docker_open5gc.sh

check if any error comming ----------------- check any error need resolve 




#       Below is open5gc code and all setting
# docker_open5gs
